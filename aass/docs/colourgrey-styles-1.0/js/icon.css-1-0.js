function myicofunction1() {
  ...
  for (var i = 0; i < icoxxx1.length; i++) {
    ...
    var naeyong5 = `<span style="background-image:url(https://chonggi-tokhu.github.io/aass/docs/colourgrey-styles-1.0/${icoxsrc1});height:20px;width:20px;display:block;"></span>`;
