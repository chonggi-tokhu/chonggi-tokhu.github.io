...
<body onload="myinph4function()">
    <div>
        ...
        <div>
            ...
            <div>
                ...
                <div id="mycontent16" contenteditable="true" onkeyup="myplaceholderi8()">
                    <div class="mycontent17" id="mycontent17">쓰세요</div>
                </div>
                ...
                <div style="position: absolute;right:10px;" id="html-mode-5">
                    <textarea name="htmlmode1" id="htmlmode1" cols="50" rows="10" placeholder="html edit mode"></textarea>
                    <br>
    ...
    if ($ip == "192.168.35.177") {
        ...
        $myfilename = fopen("./post/" . $myfilename12 . ".html", "x");
